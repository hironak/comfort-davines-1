...
ActiveRecord::Schema.define(version: 20131205081611) do
  ...
  create_table "dealers_admin_roles", id: false, force: true do |t|
    t.integer "dealer_id"
    t.integer "admin_role_id"
  end

  add_index "dealers_admin_roles", ["dealer_id", "admin_role_id"], name: "index_dealers_admin_roles_on_dealer_id_and_admin_role_id", using: :btree
