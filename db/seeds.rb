...
# NewsRelease.create(
#   date: "2013-03-20",
#   title: "3月27日より伊勢丹新宿ビューティアポセカリーにてキット販売中！",
#   body: "<新商品オイオイルにナチュラルテック>＜N＞のシャンプー、コンディショナーがついた伊勢丹限定キットです。"
# )
#
# NewsRelease.create(
#   date: "2013-03-01",
#   title: "3月 6日よりJR 大阪三越伊勢丹で発売開始！",
#   body: "大阪伊勢丹8階にオーセンティックとナチュラルテック（一部の商品）取扱中。"
# )
...
CSV.read(Rails.root.join("presets/data/press_releases.csv").to_s, headers: :first_row, col_sep: "\t").each do |attrs|
  ...
  attrs['image'] = File.new(file_path) if File.exist?(file_path)
