module Administration
  class ProductsController < BaseController
    ...
    def product_params
      params.require(:product).permit(:name, :refnum, :price, :stock, :sample, :page_id, :backmargin_salon, :backmargin_agency, photos_attributes: [ :image ], series_ids: [], category_ids: [], solution_ids: [])
    end
  end
end
