module Administration
  class ProductsController < BaseController
    ...
    def product_params
      params.require(:product).permit(:name, :refnum, :price, :stock, :small_detail, :sample, :page_id, :backmargin_salon, :backmargin_agency, photos_attributes: [ :id, :image, :_destroy ], series_ids: [], category_ids: [], solution_ids: [])
    end
  end
end
