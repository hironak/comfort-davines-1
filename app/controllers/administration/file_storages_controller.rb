    ...
    def create
      ...
      respond_to do |format|
        if @file_storage.save
          format.html { redirect_to [:admin, @file_storage], notice: rmt(:successfully, :created, @file_storage) }
    ...
    def update
      respond_to do |format|
        if @file_storage.update(file_storage_params)
          format.html { redirect_to [:admin, @file_storage], notice: rmt(:successfully, :updated, @file_storage) }
