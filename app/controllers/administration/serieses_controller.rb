  ...
  class SeriesesController < BaseController
    ...
    def create
      ...
      respond_to do |format|
        if @series.save
          format.html { redirect_to [:admin, @series], notice: rmt(:successfully, :created, @seriese) }
    ...
    def update
      respond_to do |format|
        if @series.update(series_params)
          format.html { redirect_to [:admin, @series], notice: rmt(:successfully, :updated, @seriese) }
    ...
    def series_params
      params.require(:series).permit(:name, :identify, :show_on, :topimage)
    end
  end
end
