Commers::Application.configure do
  ...
  config.assets.precompile += %w( administration/base.css administration/base.js )
  config.assets.precompile += %w( mobile/application.css mobile/applocation.js )
  ...
  config.action_mailer.default_url_options = {
    host: ENV['HOSTNAME'] || 'davines.co.jp'
  }

  if Rails.env.production? && ENV['GOOGLE_ANALYTICS_TRACKER']
    config.middleware.use Rack::GoogleAnalytics, :tracker => lambda do |env|
